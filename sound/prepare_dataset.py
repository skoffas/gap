...
# TODO: check inverse.mfcc_to_audio(mfcc[, n_mels, …]) for sound generation
# from mfccs
...
if __name__ == "__main__":
    ...
    if args.features == "mfccs":
        json_path = (f"mfcc_{args.n_mfcc}_{args.n_fft}_{args.l_hop}_"
                     f"{args.samples}_{args.path}.json")
    else:
